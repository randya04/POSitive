                ...
                <Popover>
                  ...
                  <PopoverContent align="start" sideOffset={8} className="min-w-[220px] w-64 p-4">
                    <div className="grid gap-2">
                      <Label>Rol</Label>
                      <Popover open={roleComboboxOpen} onOpenChange={(val: boolean) => setRoleComboboxOpen(val)}>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                        ...
                        <PopoverContent align="start" className="w-full p-0 mt-1">
                          <Command className="w-full">
                            <CommandInput
                              ...
                              onValueChange={(value: string) => setRoleComboboxQuery(value)}
                      ...
                      <Label>Estado</Label>
                      <Popover open={statusComboboxOpen} onOpenChange={(val: boolean) => setStatusComboboxOpen(val)}>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                            className="w-full justify-between"
                        ...
                        <PopoverContent align="start" className="w-full p-0 mt-1">
                          <Command className="w-full">
                            <CommandInput
                              ...
                              onValueChange={(value: string) => setStatusComboboxQuery(value)}
                      ...
                      <Popover open={restaurantComboboxOpen} onOpenChange={(val: boolean) => setRestaurantComboboxOpen(val)}>
                        <PopoverTrigger asChild>
                          <Button
                            variant="outline"
                            className="w-full justify-between"
                        ...
                        <PopoverContent align="start" className="w-full p-0 mt-1">
                          <Command className="w-full">
                            <CommandInput
                              ...
                              onValueChange={(value: string) => setRestaurantComboboxQuery(value)}
                ...
                <SheetContent side="right" className="max-w-lg">
                  ...
                  <div className="grid gap-4 p-4">
                    <div className="grid gap-2">
                      ...
                      <Input id="name" value={name} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setName(e.target.value)} placeholder="Nombre completo" />
                      {errors.name && <p className="text-red-600 text-sm">{errors.name}</p>}
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="email">Email</Label>
                      <Input id="email" type="email" value={emailValue} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmailValue(e.target.value)} placeholder="usuario@ejemplo.com" />
                      {errors.email && <p className="text-red-600 text-sm">{errors.email}</p>}
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="phone">Teléfono</Label>
                      <Input id="phone" type="tel" value={phone} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPhone(e.target.value)} placeholder="Teléfono" />
                      {errors.phone && <p className="text-red-600 text-sm">{errors.phone}</p>}
                    </div>
                    <div className="grid gap-2">
                      <Label htmlFor="role">Rol</Label>
                      <Select value={roleValue} onValueChange={(value: 'Admin'|'Host'|'Super Admin') => setRoleValue(value)}>
                  ...
                  <SheetFooter className="flex flex-row justify-end gap-2">
                    <Button variant="outline" onClick={() => { setOpen(false); setName(''); setEmailValue(''); setRestaurantQuery(''); setSelectedRestaurantId(null); setSelectedBranchId(null); setPhone(''); setIsActive(true) }}>
                      Cancelar
                    </Button>
